        ...
        it('Can build swap order', () => {
            ...
            return minswap.buildSwapOrder(liquidityPool, defaultSwapParameters)
                .then((payments: PayToAddress[]) => {
                    ...
                    expect(payments[0].datum).toBe('d87986d87982d8798142ed56d87981d87981d8798142ed56d87982d8798142ed56d87981d87981d8798142bac6d87a80d87982d87982581cf66d78b4a3cb3d37afa0ec36461e51ecbde00f26c8f0a68f94b6988044695553441b00004d616c553b2d1a001e84801a001e8480');
                });
        });
